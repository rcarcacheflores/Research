...
In the [previous post](https://rcarcacheflores.github.io/Research/post9/), we used a crypto news database scraped from Reuters to perform LDA topic modelling. This time, I will present an overview of [spaCy](https://spacy.io), one of the most important Natural Language Processing  (NLP) libraries for Python. The objective of this post is to do the following:
