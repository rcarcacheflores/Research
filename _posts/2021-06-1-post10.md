...
Isn't that interesting? The model is able to identify punctuation, proper nouns like **India**, and verbs such as **penalising** with its respective lemma or cannonical form. If this impressed you, the next step is really fascinating:
