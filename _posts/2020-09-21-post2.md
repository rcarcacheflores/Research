...
For those who are new to Python (like me), be sure to visit this [Overview of JupyterLab](https://jupyterlab.readthedocs.io/en/stable/)

Additionally, this is a good [tutorial](https://www.datacamp.com/community/tutorials/markdown-in-jupyter-notebook) on using Markdown with Jupyter Noteboks. 
