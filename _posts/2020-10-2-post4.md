...
Once again, we will be using the "USA_data.csv", which you can find on my Research repository, under the databases folder. This database compiles three variables from FRED for the years 1984-2014, espressed in billions USD: Real GDP, Savings, Taxes. Make sure to properly specify your file path when loading the document. 
...
#Additionally, the color name was added, which is one of my favorites for plots if you recall the previous post.
