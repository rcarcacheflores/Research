...
img: post7.jpg
tags: [Research, Word clouds, R, travel, reviews, Kaggle]
---
...
this July, when I visited the Algarve. During my first night someone
...
```
    ...
    ##  $ Review: Factor w/ 20491 levels "1 best hotels new york, hotel absoutly brilliant, rooms nice cosy, bed nice comfortable, views just magnificent"| __truncated__,..: 14068 15694 14577 19374 9883 12187 3097 4563 11252 4617 ...
...
![](2020-10-25-post7_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
This is the first complete review. Next, we will need to perform some
common cleaning steps to remove punctuation and other characters that
may clutter the word clouds. Additionally, we can also remove filler or
...
```
    ...
    ## Warning in tm_map.SimpleCorpus(reviews_corpus, tolower): transformation
    ## drops documents
...
```
    ...
    ## Warning in tm_map.SimpleCorpus(corpus_clean, removePunctuation):
    ## transformation drops documents
...
```
    ...
    ## Warning in tm_map.SimpleCorpus(corpus_clean, stripWhitespace):
    ## transformation drops documents
...
![](2020-10-25-post7_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
```
    ...
    ## Warning in tm_map.SimpleCorpus(corpus_clean, removeWords, c("hotel",
    ## "good", : transformation drops documents
...
![](2020-10-25-post7_files/figure-markdown_github/unnamed-chunk-8-1.png)
