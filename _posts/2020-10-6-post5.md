...
this short time period. The variables are coded as follow: 1. *obesity*:
represents an estimate of the national prevalence of obesity as a
percentage of the total population. 2. *PPC*: stands for GDP per capita.
3. *KCAL*: an estimate of the average daily calorie intake for a person
in a given country. 4. *div*: an estimate of the dietary
diversification, given as a percentage. Countries with higher values of
div have diets comprised of more varied food groups. 5. *poverty*:
percentage of the population living below the global poverty line. 6.
*consumption*: the average spent on consumption as a proportion of a
household’s income in a given country. 7. *popdens*: is a country’s
population density, taken from the World Bank. 8. *OECD*: binary
variable which takes the value of 1 if a country belongs to this group.
...
![logit plot#2]({{site.baseurl}}/assets/img/post5_p4.png)
