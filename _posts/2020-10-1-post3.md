...
```
    ...
    ## [1] "C:/Users/r_jun/Documents/Research with R and Python"
...
``` r
#we reject the null, and see that there is positive correlation between both variables. This clearly makes sense from a national accounts perspective
```
...
![](2020-10-1-post3_files/figure-markdown_github/unnamed-chunk-6-1.png)
Note that the order of the imput matters, as the taxes are added
automatically to the x-axis and Real.GDP is interpreted in the y axes.
Clearly this is a very simple plot, but we can customize it in the
following way:
