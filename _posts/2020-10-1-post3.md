...
1984-2014, espressed in billions USD: Real GDP, Savings, Taxes.

The data was collected from [FRED](https://fred.stlouisfed.org) and was used in a SEM model I performed
a few years ago. The first step is to download the data from my Research
repository (the link is on the github icon to the left and the 
