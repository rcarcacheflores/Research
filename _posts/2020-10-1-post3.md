...
![graph1](https://github.com/rcarcacheflores/Research/images/_postpics/post3_p1.png)
...
![]({{"./images/_postpics/post3_p2.png"|absolute_url}})
...
```
![]({{"./images/_postpics/post3_p3.png"|absolute_url}})
...
```
![]({{"./images/_postpics/post3_p4.png"|absolute_url}})
...
![]({{"./images/_postpics/post3_p5.png"|absolute_url}})
